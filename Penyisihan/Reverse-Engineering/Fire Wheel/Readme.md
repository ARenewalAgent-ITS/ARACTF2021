...
xor	qword ptr [r9], rax

# r9 + 8 <= r8 + 8 (second 8 byte)
mov	rax, qword ptr [r8 + 8]
xor	qword ptr [r9 + 8], rax

# r9 rotate left 0x39
rol	qword ptr [r9], 0x39

# r9+8 rotate right 0x13
ror	qword ptr [r9 + 8], 0x13

# r9 xor with value in 0x400000
mov	rax, qword ptr [0x400000]
xor	qword ptr [r9], rax

# r9 xor with value in 0x400008
mov	rax, qword ptr [0x400008]
xor	qword ptr [r9 + 8], rax

# rax = r9 xor with value in 0x400028
mov	rax, qword ptr [0x400028]
xor	rax, qword ptr [r9]

# rdx = r9 xor with value in 0x400030
mov	rdx, qword ptr [0x400030]
xor	rdx, qword ptr [r9 + 8]
